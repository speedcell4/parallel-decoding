...
MODEL_FLOPS = collections.OrderedDict([
    ...
    ("Shallow + KD",
     TransformerHparams(512, 13, i=2048).get_train_flops(250, 300000) + TransformerHparams(512, 13, i=2048,
    ...
    ("F-VAE", TransformerHparams(512, 12, i=2048).get_train_flops(250, 300000) + TransformerHparams(512, 12, i=2048,
                                                                                                    heads=16).get_train_flops(
        250, 300000, use_backprop=False)),
    ("DisCo", TransformerHparams(512, 12, i=2048).get_train_flops(250, 300000) + TransformerHparams(1024, 24, i=4096,
                                                                                                    heads=16).get_train_flops(
        250, 300000, use_backprop=False)),
